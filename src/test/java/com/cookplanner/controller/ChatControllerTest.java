...
import com.cookplanner.dto.ChatSendRequest;
import com.cookplanner.dto.ChatSendResponse;
...
class ChatControllerTest {
    ...
    void successfulTextResponse_mapsToTextType() {
        ...
        when(toolResultCollector.hasResult()).thenReturn(false);
    ...
    void toolResult_mapsToRecipeCreated() {
        ...
        when(toolResultCollector.hasResult()).thenReturn(true);
        when(toolResultCollector.primaryResponseType()).thenReturn("recipe_created");
        when(toolResultCollector.toAggregatedData()).thenReturn(data);
