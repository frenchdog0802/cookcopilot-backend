...
import com.cookcopilot.service.PantryItemService;
...
public class PantryItemController {
    ...
    private PantryItemDto toDto(PantryItem item) {
        ...
        if (item.getNotes() != null) details.put("notes", item.getNotes());

        String name = null;
        if (item.getIngredientId() != null) {
            name = ingredientRepository.findById(item.getIngredientId())
